<template>
    <v-dialog v-model="dialog.buy_crypto" width="500" @click:outside="cancel">
            ...
            <v-form @submit.prevent="submit" ref="form" v-model="valid">
                ...
                <v-card-text>
                    <v-row dense>
                        ...
                        <v-col cols="4">
                            <v-text-field :rules="rules" placeholder="1" v-model="quantity" @input="update()">
                                <template v-slot:label>
                                    <p>quantity</p>
                                </template>
                            </v-text-field>
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            this.bank.get(this.data.symbol).buy(coin, quantity);

            this.dialog.buy_crypto = false;
    ...
    watch: {
        'dialog.buy_crypto'(val) { if (val == true) { this.populate() } },
    }
}
</script>
